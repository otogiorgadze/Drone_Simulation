let flight = [
    { height:"260", availability:"available", arrive:"NULL"},
    { height:"270", availability:"available", arrive:"NULL"},
    { height:"280", availability:"available", arrive:"NULL"},
    { height:"290", availability:"available", arrive:"NULL"},
    { height:"300", availability:"available", arrive:"NULL"},
    { height:"310", availability:"available", arrive:"NULL"},
    { height:"320", availability:"available", arrive:"NULL"},
    { height:"330", availability:"available", arrive:"NULL"},
    { height:"340", availability:"available", arrive:"NULL"},
    { height:"350", availability:"available", arrive:"NULL"},
    { height:"360", availability:"available", arrive:"NULL"},
    { height:"370", availability:"available", arrive:"NULL"},
    { height:"380", availability:"available", arrive:"NULL"},
    { height:"390", availability:"available", arrive:"NULL"},
    { height:"400", availability:"available", arrive:"NULL"}
];
let time_left = {};
function wait_time(){
...
function approgit push -u origin mainval(i, distance){
